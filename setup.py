...
setup(
  ...
  version = '1.7.8',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/marvmilo/marvmiloTools/archive/refs/tags/v1.7.8.tar.gz',    # I explain this later on
