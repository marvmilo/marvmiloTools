...
setup(
  ...
  description = 'Tools for using on diffren Platforms',   # Give a short description about your library
  ...
  download_url = 'https://github.com/marvmilo/marvmiloTools/archive/refs/tags/v0.1.tar.gz',    # I explain this later on
